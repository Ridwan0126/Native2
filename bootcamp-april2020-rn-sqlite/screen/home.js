...
class Home extends Component {
  ...
  onButtonChangePressed = () => {
    this.props.changeUserLogin(this.state.name);
  };
  ...
  render() {
    console.log('usernameLogin:', this.props.usernameLogin);
    return (
      <View style={styles.container}>
        ...
        <Button
          title="Change Redux"
          type="outline"
          onPress={this.onButtonChangePressed}
        />
        <FlatList
